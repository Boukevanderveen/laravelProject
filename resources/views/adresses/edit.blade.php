...
@section('content')
    ...
    <div class="row">
        <div class="col-12 card">
            <form method="post" name="productform" action="{{ route('adresses.update', $adress) }}">
            <input value="invoiceadress" type="hidden" name="type">
                <div class="row mb-3 mt-3">
                    <label for="name" class="col-md-4 col-form-label text-md-end">Naam:</label>
                    <div class="col-md-5">
                        <input class="form-control @error('name') is-invalid @enderror" id="name"
                            value="{{ old('name', $adress->name)}}" type="text" name="name" autofocus>
                        @if ($errors->has('name'))
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('company_name') is-invalid @enderror" id="company_name"
                            value="{{ old('company_name', $adress->company_name)}}" type="text" name="company_name" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('street') is-invalid @enderror" value="{{ old('street', $adress->street)}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <input class="form-control @error('house_number') is-invalid @enderror" value="{{ old('house_number', $adress->house_number)}}" type="text" id="house_number" name="house_number"autofocus>
                    ...
                    <div class="col-md-1">
                        <input class="form-control @error('addition') is-invalid @enderror" value="{{ old('addition', $adress->addition)}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('zipcode') is-invalid @enderror" id="zipcode"
                            value="{{ old('zipcode', $adress->zipcode)}}" type="text" name="zipcode" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('city') is-invalid @enderror" id="city"
                            value="{{ old('city', $adress->city)}}" type="text" name="city" autofocus>
                        @if ($errors->has('city'))
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('phone_number') is-invalid @enderror" value="{{ old('phone_number', $adress->phone_number)}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5">
                        <input class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $adress->email)}}"
                ...
                <div class="row">
                    <div class="col-7"></div>
                    <div class="col-5">
                        <a href="{{ route('adresses.index') }}"><button type="button" class="btn mb-3">Ga
                                terug</button></a>
