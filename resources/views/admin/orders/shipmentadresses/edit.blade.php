...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a  class="nav-link active"   aria-current="page" href="{{ route('admin.orders.shipmentadresses.edit', [$order, $shipmentAdress]) }}">Bezorgadres</a>
    <li class="nav-item">
...
<div class="row">
    <div class="col-12 card">
        <form method="post" name="orderform" action="{{ route('admin.orders.shipmentadresses.update', [$order, $shipmentAdress]) }}">
            <div class="row mb-3  mt-4">
                <label for="name" class="col-md-4 col-form-label text-md-end">Naam:</label>
                <div class="col-md-5">
                    <input value="{{old('name', $shipmentAdress->name)}}" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" autofocus>
                    @if ($errors->has('name'))
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-5">
                    <input class="form-control @error('street') is-invalid @enderror" value="{{ old('street', $shipmentAdress->street) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    <input class="form-control @error('house_number') is-invalid @enderror"
                        value="{{ old('house_number', $shipmentAdress->house_number) }}" type="text" id="house_number" name="house_number"
                        autofocus>
                ...
                <div class="col-md-1">
                    <input class="form-control @error('addition') is-invalid @enderror" value="{{ old('addition', $shipmentAdress->addition) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-5">
                    <input class="form-control @error('zipcode') is-invalid @enderror" id="zipcode"
                        value="{{ old('zipcode', $shipmentAdress->zipcode) }}" type="text" name="zipcode" autofocus>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-5">
                    <input class="form-control @error('city') is-invalid @enderror" id="city"
                        value="{{ old('city', $shipmentAdress->city) }}" type="text" name="city" autofocus>
                    @if ($errors->has('city'))
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-5">
                    <input value="{{old('email', $shipmentAdress->email)}}" id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" autofocus>
                    @if ($errors->has('email'))
